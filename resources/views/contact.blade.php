...
<div class="hero-section">
    ...
    {{-- <div class="social-btns">
        ...
        <a class="btn dribbble" href="#"><i class="icofont-dribbble"></i></a>
        <a class="btn skype" href="#"><i class="icofont-skype"></i></a>
    </div> --}}
            ...
            <div class="contact-wrapper mt-1 pt-1 padding-top padding-bottom mt--100 mt-lg--440">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5 d-lg-block d-none">
                        <img src="{{ asset('images/contact.png') }}" class="w-100" alt="images">
                    </div>
                </div>
            </div>
        </div>
