                    ...
                    <div class="dashboard-widget mb-30 mb-lg-0">
                        ...
                        <li>
                            ...
                            <li>
                                ...
                                <a href="/dashboard-favorites" class="active"><i class="flaticon-star"></i>My Favorites</a>
                                <!-- </button> -->
                            </li>
...
<!-- My Favorites -->
<!-- =========================== --> 
<div class="col-lg-8" id="my-favorites" class="s2">
                    ...
                    <div class="row mb-30-none justify-content-center">
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="assets/{{ asset('images/auction/product/04.png') }}" alt="car"></a>
                        ...
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="assets/{{ asset('images/auction/product/05.png') }}" alt="car"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="assets/{{ asset('images/auction/product/06.png') }}" alt="product"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
                        ...
                        <div class="col-sm-10 col-md-6">
                            <div class="auction-item-2">
                                <div class="auction-thumb">
                                    <a href="product-details.html"><img src="assets/{{ asset('images/auction/product/09.png') }}" alt="product"></a>
                                    <a href="#0" class="rating"><i class="far fa-star"></i></a>
                                    <a href="#0" class="bid"><i class="flaticon-auction"></i></a>
                                </div>
                                <div class="auction-content">
