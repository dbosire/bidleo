 ...
 <div class="hero-section">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li>
                    <span>Customer Care Register</span>
                </li>
            </ul>
        </div>
            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side justify-content-center align-items-center">
                    <div class="section-header">
                        ...
                        <p>Welcome to the bidleo customer care team. Plese fill in the following details.</p>
                    </div>
                    <!-- <ul class="login-with">
                        <li>
                    ...
                    <form class="login-form" method="POST" action="{{ route('create.customer.care') }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="role" name="role" value="customer_care">
                ...
                <div class="right-side cl-white">
                    <div class="section-header mb-0">
                        ...
                        <p>To receive your pin</p>
                        <h4>Participate In Your First Bid</h4>
